...
/**
*	This class defines UI objects of Map Text result Page for Std Browsers for Authentication Page
*	@version 1.0
*	@author Amitha
*/
...
public class MapResultPageUiStdAuth {
	
	private static MapResultPageUiStdAuth mtrInstd = null;
	private browserpage page;
	
	private MapResultPageUiStdAuth(browserpage page) {
		this.page = page;
		initUIElements();
	}

	public static MapResultPageUiStdAuth getInstance(browserpage page) {
		if (null == mtrInstd) {
			mtrInstd = new MapResultPageUiStdAuth(page);
		}
		return mtrInstd;
	}
	...
	public void initUIElements(){
		...
		FindBizNearby_I      	= new image     (page,"//div[3]/img");
		FindBizLocNearby		= new link 		(page,"//div[3]/a");
